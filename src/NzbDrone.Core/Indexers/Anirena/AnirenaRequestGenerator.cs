...
{
    public class AnirenaRequestGenerator : IIndexerRequestGenerator
    {
        public AnirenaSettings Settings { get; set; }
        ...
        {
            var baseUrl = $"{Settings.BaseUrl.TrimEnd('/')}/rss.php?{Settings.AdditionalParameters}";
